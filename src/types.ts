export interface Book {
  ...
  downloadedBy?: string[]; // Array of unique visitor hashes/IDs that downloaded this book edition
  isFeatured: boolean;
  createdAt: number;
...
export interface UiTexts {
  ...
  topCustomBgType?: 'image' | 'video' | 'animated_video';
  topCustomImageUrl?: string;
  topCustomVideoUrl?: string;
  topCustomVideoMuted?: boolean;
  topCustomVideoLoop?: boolean;
  topCustomVideoSpeed?: number;
  topCustomVideoCompressed?: boolean;
  topCustomShowGridPattern?: boolean;
