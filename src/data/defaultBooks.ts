...
export const defaultAuthorBio: AuthorBio = {
  ...
  titleAr: 'كاتب ومؤلف وصانع محتوى هادف',
  ...
  bioAr: 'رحلتي غيبوبة،، كاتب، مؤلف، وصانع محتوى ملهم، بدأ مسيرته مع القلم منذ سن الثالثة عشرة، يمتلك رؤية عميقة صقلتها التجارب الحياتية الغنية، ونجح في تحويلها إلى محتوى مؤثر حصد مئات الملايين من المشاهدات عبر منصات التواصل الاجتماعي، ويكرّس فكره وقلمه لتقديم الدعم النفسي والنصائح الحياتية، تاركًا أثرًا إيجابيًا ملموسًا في حياة الناس، بشهادة جمهور واسع وجد في كلماته وتوجيهاته إلهامًا وسندًا حقيقيًا.',
