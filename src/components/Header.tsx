              ...
              <AnimatePresence>
                {showPostsBanner && uiTexts.disablePostsNotifications !== true && (
                  <motion.div
                    ...
                    className={`absolute top-full left-1/2 -translate-x-1/2 mt-3.5 z-[100] w-72 max-w-[calc(100vw-24px)] rounded-lg border border-brand-gold/40 bg-gradient-to-b from-[#161a1d] to-[#0a0c0e] p-3.5 shadow-[0_12px_30px_rgba(0,0,0,0.9),_0_0_20px_rgba(212,175,55,0.2),_inset_0_1px_1px_rgba(255,255,255,0.1)] backdrop-blur-md overflow-hidden ${
              ...
              <AnimatePresence>
                {showPostsBanner && uiTexts.disablePostsNotifications !== true && (
                  <motion.div
                    ...
                    transition={{ type: 'spring', damping: 14, stiffness: 200 }}
                    style={{ perspective: 1000 }}
                    className={`fixed top-20 left-3 right-3 sm:left-auto sm:right-6 sm:absolute sm:top-full sm:mt-3.5 z-[100] sm:w-64 max-w-[calc(100vw-24px)] rounded-lg border border-brand-gold/40 bg-gradient-to-b from-[#161a1d] to-[#0a0c0e] p-3 shadow-[0_12px_30px_rgba(0,0,0,0.9),_0_0_20px_rgba(212,175,55,0.2),_inset_0_1px_1px_rgba(255,255,255,0.1)] backdrop-blur-md overflow-hidden ${
                      isRtl ? 'text-right' : 'text-left'
                    }`}
                  >
